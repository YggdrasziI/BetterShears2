...
public class BlockAmethystOre extends Block implements IHasModel
{
    public BlockAmethystOre(String name, Material material, CreativeTabs tab) 
    {
        super(material);
